      ...
      <div className="w-full">
        <div className="relative">
          ...
          <input
            ref={ref}
            className={cn(
              "flex min-h-[40px] sm:min-h-[44px] w-full rounded-lg border border-white/20 bg-white/10 backdrop-blur-sm py-2 sm:py-3 text-[16px] transition-all duration-200 text-white placeholder:text-white/50",
