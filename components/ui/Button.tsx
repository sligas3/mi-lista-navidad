...
const button = cva(
  "inline-flex items-center justify-center rounded-lg font-semibold transition-all duration-200 focus-ring disabled:opacity-50 disabled:pointer-events-none active:scale-95 hover:scale-[1.02]",
  {
    variants: {
      ...
      size: {
        sm: "min-h-[32px] px-2 py-1.5 text-xs sm:min-h-[40px] sm:px-3 sm:py-2.5 sm:text-sm",
        md: "min-h-[36px] px-2.5 py-2 text-xs sm:min-h-[44px] sm:px-4 sm:py-3 sm:text-base",
        lg: "min-h-[40px] px-3 py-2 text-sm sm:min-h-[48px] sm:px-6 sm:py-3.5 sm:text-lg",
      },
    },
    defaultVariants: {
      variant: "primary",
