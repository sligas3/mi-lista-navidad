...
export default function HeaderNavidad() {
  return (
    <header className="text-center mb-6 sm:mb-8 md:mb-12 animate-in px-3 sm:px-4">
      <h1 className="font-display text-2xl xs:text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-2 sm:mb-3 md:mb-4 drop-shadow-2xl tracking-tight">
        Mi Lista de Deseos
      </h1>
