...
export default function Stats({ wishes }: StatsProps) {
  ...
  return (
    <div className="glass-effect rounded-xl sm:rounded-2xl p-4 sm:p-6 md:p-8 mb-4 sm:mb-6 border border-navidad-dorado/30 card-hover relative overflow-hidden">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-2 sm:gap-3 md:gap-4 relative z-10">
        <div className="bg-gradient-to-br from-white/20 to-white/10 rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 text-center border border-white/20 card-hover">
        ...
        <div className="bg-gradient-to-br from-green-500/30 to-green-500/20 rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 text-center border border-green-400/30 card-hover">
        ...
        <div className="bg-gradient-to-br from-yellow-500/30 to-yellow-500/20 rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 text-center border border-yellow-400/30 card-hover">
        ...
        <div className="bg-gradient-to-br from-navidad-dorado/30 to-navidad-dorado/20 rounded-lg sm:rounded-xl p-2 sm:p-3 md:p-4 text-center border border-navidad-dorado/40 card-hover">
